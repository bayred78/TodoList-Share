...
## 2026-03-16 02:16 — 뱃지 깜빡임 버그 수정
- `MainPage.jsx`: 채탕/체크리스트 뱃지 표시 300ms 딜레이 추가 (로딩 깜빡임 방지), 뱃지 판정에 본인 수정 제외 로직 및 채팅 아이콘 변경(💬→❗)
- `ProjectPage.jsx`: 채팅탭 뱃지에 로딩 완료 플래그 적용 및 본인 채팅 제외 로직 추가
- Git 태그: `v260316-0216`
- 복원: `git checkout v260316-0216`
